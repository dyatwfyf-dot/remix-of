...
export default function JournalTab() {
  ...
  return (
    <div className="w-full space-y-3 overflow-x-hidden p-1.5 sm:p-3" dir="rtl">
      {/* ══ بطاقة إدخال القيد — رأس بتدرج فاتح لامع بدل الغامق ══ */}
      <section className="overflow-hidden rounded-2xl border border-slate-200 bg-white shadow-sm">
        <div
          className="relative px-2 py-2 sm:px-4 sm:py-3"
          style={{
        ...
        >
          ...
          <div className="grid grid-cols-2 items-center gap-2 sm:gap-2">
            <div className="flex min-w-0 items-center gap-2.5">
              ...
              <div className="min-w-0">
                <h3 className="truncate text-[15px] font-bold text-[#0f4a44]">
                  {editingId ? "تعديل القيد المركب" : "قيد يومية مركب"}
                </h3>
                <p className="truncate text-xs font-medium text-[#3a6b62]">
          ...
          <div className="mt-2 border-t border-black/10 pt-2 sm:mt-2.5 sm:pt-2.5">{tabActions}</div>
        </div>
          ...
          <div className="overflow-hidden rounded-2xl border border-slate-200">
            <div className="overflow-auto max-h-[72vh]">
              <table className="min-w-max table-auto border-collapse text-right text-sm sm:text-base font-semibold">
                <thead
                  style={{
                    background: "linear-gradient(135deg, #f2fbfa 0%, #d4f0ec 100%)",
                    color: "#0f4a44",
                  }}
                >
                  <tr>
      ...
      {/* ══ سجل القيود (جدول واحد لكل الأحجام) — رأس بتدرج فاتح لامع بدل الغامق ══ */}
      <section className="overflow-hidden rounded-2xl border border-slate-200 bg-white shadow-sm">
        <div
          className="grid grid-cols-[minmax(0,1fr)_auto] items-center gap-2 sm:gap-3 px-2 py-2 sm:px-4 sm:py-2.5"
          style={{
            background: "linear-gradient(135deg, #f2fbfa 0%, #d4f0ec 100%)",
            boxShadow: "inset 0 1px 0 rgba(255,255,255,0.9)",
          }}
        >
          <h3 className="truncate text-[14px] font-bold text-[#0f4a44]">سجل القيود اليومية</h3>
          <div className="flex min-w-0 items-center justify-end gap-1.5 sm:gap-2">
            {Object.values(journalFilters).some(Boolean) && (
              <button
                onClick={clearJournalFilters}
                className="min-w-0 rounded-full bg-white px-2 py-1 text-[11px] font-bold text-[#0f4a44] border border-black/10 transition-colors hover:bg-[#eafaf7] sm:text-xs"
              >
                مسح التصفية
              </button>
            )}
            <span className="shrink-0 rounded-full bg-white px-2.5 py-0.5 text-xs font-bold text-[#0f4a44] border border-black/10">
