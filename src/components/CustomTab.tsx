  ...
  return (
    <div className="space-y-4">
      ...
      <div className="bg-card rounded-xl border p-4 overflow-x-auto">
        <table className=" w-auto table -auto text-sm sm:text-base">
          <thead className="bg-secondary text-secondary-foreground">
            <tr>
              <th className="text-center !px-0.5 !py-1 sm:!px-1 sm:!py-1 !text-[10px] sm:!text-xs whitespace-nowrap">م</th>
              {tab.columns.map((c) => (
                <th key={c} className="text-center whitespace-nowrap !px-0.5 !py-1 sm:!px-1 sm:!py-1 !text-[10px] sm:!text-xs">
                  {c}
                </th>
              ))}
              <th className="text-center
              !px-0.5 !py-1 sm:!px-1 sm:!py-1 !text-[15px] sm:!text-xs whitespace-nowrap">إجراءات</th>
            </tr>
          </thead>
          <tbody>
            {tab.rows.map((r, i) => (
