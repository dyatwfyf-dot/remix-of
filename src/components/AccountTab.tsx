...
<div
  ...
  style={{
    ...
    boxShadow: "inset 0 1px 0 rgba(255,255,255,0.9), 0 4px 14px rgba(150,220,205,0.3)",
  }}
>
  <div>
    <h1 className={`${HEADING_MOBILE} text-[#0f4a44] text-sm font-bold tracking-tight`}>
      الحساب الجاري
    </h1>
    <p className="text-xs text-[#5c6b4a] font-bold tracking-wide mt-0.5">
      سجل الحركات المالية المُرحّلة
    </p>
  </div>

  <div className="hidden sm:flex items-center gap-2 px-3.5 py-2 rounded-xl bg-white border border-black shadow-sm">
    <Landmark className={`${ICON_MOBILE} text-[#0f4a44]`} />
    <span className="text-sm text-[#0f4a44] font-bold">عدد القيود</span>
...
<div className="accounts-print-hide grid grid-cols-2 gap-2">
  <LedgerStat
    ...
    style={{
      ...
      borderColor: "#000",
      color: "#7a5c00",
      boxShadow: "inset 0 1px 0 rgba(255,255,255,0.9), 0 4px 14px rgba(255,213,74,0.35)",
    }}
    value={totalIncome}
    tone="income"
  ...
  <LedgerStat
    ...
    style={{
      ...
      borderColor: "#000",
      color: "#7a2a1a",
      boxShadow: "inset 0 1px 0 rgba(255,255,255,0.9), 0 4px 14px rgba(255,140,120,0.3)",
    }}
    value={totalExpense}
    tone="expense"
  ...
  <LedgerStat
    ...
    style={{
      ...
      borderColor: "#000",
      color: "#0f4a5c",
      boxShadow: "inset 0 1px 0 rgba(255,255,255,0.9), 0 4px 14px rgba(130,210,230,0.35)",
    }}
...
<div
  ...
  style={{
    ...
    borderColor: "#000",
    boxShadow: "inset 0 1px 0 rgba(255,255,255,0.9), 0 4px 14px rgba(160,220,140,0.3)",
  }}
>
  <div
...
<div
  ...
  style={{
    ...
    borderColor: "#000",
    boxShadow: "inset 0 1px 0 rgba(255,255,255,0.9), 0 4px 14px rgba(230,190,130,0.3)",
  }}
>
  <div
    className="px-4 py-3 flex flex-wrap justify-between items-center gap-3 border-b border-black"
